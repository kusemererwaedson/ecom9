...
class OrderController extends Controller
{
        ...
        if($request->isMethod('post')){
            ...
            if(!empty($data['courier_name'])&&!empty($data['tracking_number'])){
                ...
                Mail::send('emails.order_status',$messageData,function($message)use($email){
                    $message->to($email)->subject('Order Status Updated - Techlens Ug');
                });
            ...
            /*$message = "Dear Customer, your order #".$data['order_id']." status has been updated to ".$data['order_status']." placed with Techlens Ug";
    ...
    public function updateOrderItemStatus(Request $request){
        if($request->isMethod('post')){
            ...
            // Send Order Status Update SMS
            /*$message = "Dear Customer, your order #".$order_id." status has been updated to ".$data['order_status']." placed with Techlens Ug";
            $mobile = $deliveryDetails['mobile'];
            Sms:sendSms($message,$mobile);*/
