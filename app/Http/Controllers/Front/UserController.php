        ...
        if($request->ajax()){
            ...
            if($validator->passes()){
                ...
                Mail::send('emails.confirmation',$messageData,function($message)use($email){
                    $message->to($email)->subject('Confirm your Techlens Ug Account');
                });
                ...
                Mail::send('emails.register',$messageData,function($message)use($email){
                    $message->to($email)->subject('Welcome to Techlens Ug');
                });*/

                /*// Send Register SMS
                $message = "Dear Customer, you have been successfully registered with Techlens Ug. Login to your account to access orders, addresses & available offers.";
                $mobile = $data['mobile'];
        ...
        if($request->ajax()){
            ...
            if($validator->passes()){
                ...
                Mail::send('emails.user_forgot_password',$messageData,function($message) use($email){
                    $message->to($email)->subject('New Password - Techlens Ug');
                });
