                                    ...
                                    <table class="u-s-m-b-13">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <h6 class="order-h6">
                                                        @if(isset($_GET['cy'])&&$_GET['cy']!="UGX")
                                                            @php 
                                                                $getCurrency = Currency::where('currency_code',$_GET['cy'])->fishst()->toArray();
                                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="order-h6"><span class="shipping_charges">shs.0</span></h6>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h6 class="order-h6">
                                                        ...
                                                        @else
                                                            @if(Session::has('couponAmount'))
                                                                <span class="couponAmount">shs.{{ Session::get('couponAmount') }}</span>
                                                            @else
                                                                shs.0
                                                            @endif
                                                        @endif
                                                ...
                                                <td>
                                                    <h3 class="order-h3">
                                                        <strong class="grand_total">
                                                            ...
                                                            @else
                                                                shs.{{ $total_price - Session::get('couponAmount') }}
                                                            @endif
                                                        </strong>
                                                    </h3>
                                                </td>
