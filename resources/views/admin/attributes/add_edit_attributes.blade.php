                    ...
                    <div class="form-group">
                      <div class="field_wrapper">
                          <div>
                              ...
                              <input type="number" name="price[]" placeholder="Price" style="width: 120px;" required="" step="0.01" min="0" />
                              <input type="number" name="stock[]" placeholder="Stock" style="width: 120px;" required="" min="0" />
