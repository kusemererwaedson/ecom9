              ...
              <div class="card">
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/personal') }}" method="post" enctype="multipart/form-data" name="updateAdminPasswordForm" id="updateAdminPasswordForm">@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="admin_mobile" placeholder="Enter 10 Digit Number" name="vendor_mobile" value="{{ Auth::guard('admin')->user()->mobile}}" required="">
                    </div>
                    <div class="form-group">
              ...
              <div class="card">
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}" method="post" enctype="multipart/form-data" name="updateAdminPasswordForm" id="updateAdminPasswordForm">@csrf
                    <div class="form-group">
                      <label>Vendor Username/Email</label>
                      <input class="form-control" value="{{ Auth::guard('admin')->user()->email}}" readonly="">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Admin_mobile">Mobile</label>
                      <input type="text" class="form-control" id="admin_mobile" placeholder="Enter 10 Digit Number" name="shop_mobile" value="{{ Auth::guard('admin')->user()->mobile}}" required="">
                    </div>
                    <div class="form-group">
                      <label for="business_license_number">Business License Number</label>
                      <input type="text" class="form-control" id="admin_mobile" placeholder="Business License Number" name="business_license_number" value="{{ $vendorDetails['business_license_number']}}" required="">
                    </div>
                    <div class="form-group">
                      <label for="gst_number">gst_number</label>
                      <input type="text" class="form-control" id="gst_number" placeholder="Enter 10 Digit Number" name="gst_number" value="{{ $vendorDetails['gst_number']}}" required="">
                    </div>
                    <div class="form-group">
                      <label for="pan_number">PAN NUMBER</label>
                      <input type="text" class="form-control" id="pan_number" placeholder="Enter 10 Digit Number" name="pan_number" value="{{ $vendorDetails['pan_number']}}" required="">
                    </div>
                    <div class="form-group">
              ...
              <div class="card">
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/bank') }}" method="post" enctype="multipart/form-data" name="updateAdminPasswordForm" id="updateAdminPasswordForm">@csrf
                    <div class="form-group">
                      <label>Vendor Username/Email</label>
                      <input class="form-control" value="{{ Auth::guard('admin')->user()->email}}" readonly="">
                    </div>
