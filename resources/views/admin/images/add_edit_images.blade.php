              ...
              <div class="card">
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <br><h4 class="card-title">Product Image</h4>
                      ...
                      @foreach($product['images'] as $image)                      
                        <tr>
                          ...
                          <td> 
                            ...
                            @endif
                            &nbsp;
                               <a class="confirmDelete" href="javascript:void(0)" module="image" moduleid="{{$image['id']}}"><i style="font-size: 25px;" class="mdi mdi-file-excel-box"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
